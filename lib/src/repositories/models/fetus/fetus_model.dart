class FetusModel {
  ...
  FetusModel.fromJson(Map<String, dynamic> json) {
    ...
    age = json['age'];
    weight = double.tryParse(json['weight'].toString().replaceAll(',', '.') ?? '0.0');
    height = double.tryParse(json['height'].toString().replaceAll(',', '.') ?? '0.0');
    headCircumference = double.tryParse(json['head_circumference'].toString().replaceAll(',', '.') ?? '0.0');
    firstWeight = double.tryParse(json['first_weight'].toString().replaceAll(',', '.') ?? '0.0');
    firstHeight = double.tryParse(json['first_height'].toString().replaceAll(',', '.') ?? '0.0');
    firstHeadCircumference = double.tryParse(json['first_head_circumference'].toString().replaceAll(',', '.') ?? '0.0');
    ...
    agePercentage = double.tryParse(json['age_percentage'].toString().replaceAll(',', '.') ?? '0.0');
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['age'] = this.age;
    data['weight'] = double.tryParse(this.weight.toString().replaceAll(',', '.') ?? '0.0');
    data['height'] = double.tryParse(this.height.toString().replaceAll(',', '.') ?? '0.0');
    data['head_circumference'] = double.tryParse(this.headCircumference.toString().replaceAll(',', '.') ?? '0.0');
    data['first_weight'] = double.tryParse(this.firstWeight.toString().replaceAll(',', '.') ?? '0.0');
    data['first_height'] = double.tryParse(this.firstHeight.toString().replaceAll(',', '.') ?? '0.0');
    data['first_head_circumference'] =
        double.tryParse(this.firstHeadCircumference.toString().replaceAll(',', '.') ?? '0.0');
