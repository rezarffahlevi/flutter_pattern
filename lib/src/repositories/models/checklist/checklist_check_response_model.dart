...
class ChecklistCheckResponseModel {
  ...
  ChecklistCheckResponseModel({this.status, this.acknowledge, this.data, this.info});
  ...
  static Map<String, dynamic> generateParams(int? fetusId, String? checkId, String? checklistId) {
    final Map<String, dynamic> data = new Map<String, dynamic>();
