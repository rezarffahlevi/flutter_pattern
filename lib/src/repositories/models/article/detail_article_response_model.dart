...
class DetailArticleResponseModel {
  ...
  DetailArticleResponseModel({this.status, this.acknowledge, this.data, this.info});
  ...
  static Map<String, dynamic> generateParams(String? categoryId, String? articleId, String? subCategoryId) {
    final Map<String, dynamic> data = new Map<String, dynamic>();
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['related_article'] != null) {
      relatedArticle = [];
      json['related_article'].forEach((v) {
        relatedArticle!.add(new ArticleModel.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.relatedArticle != null) {
      data['related_article'] = this.relatedArticle!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
